...
public class test {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            EndpointReference targetEPR = new EndpointReference("http://localhost:8080/firstAxis2_war_exploded/services/Testservice");
             ...
             *
             */
            QName qname = new QName("http://test.axiswevservice.com", "sayHello");
